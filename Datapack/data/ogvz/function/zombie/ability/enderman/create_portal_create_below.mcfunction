...
execute at @s run summon minecraft:marker ~ ~ ~ {Tags:["ogvz.marker.enderman_portal","ogvz.kill_on_reload"]}

# Kepp the chunk loaded.
forceload add ~ ~

# Tag the player so the cutscene can start.
tag @s add ogvz.zombie.class.enderman.create_portal.cutscene
