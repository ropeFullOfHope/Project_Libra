...
scoreboard players set @n[type=minecraft:marker,tag=temp.processing] ogvz.bee.pollen_bomb.lifetime.ticks 350
scoreboard players set @n[type=minecraft:marker,tag=temp.processing] ogvz.bee.pollen_bomb.heal_cooldown.ticks 0
