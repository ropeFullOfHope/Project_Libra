...
give @s minecraft:golden_pickaxe[ \
  ...
  minecraft:attribute_modifiers={ \
    modifiers:[ \
      {type:"minecraft:attack_damage",name:"minecraft:attack_damage",amount:-1.0,operation:"add_multiplied_total",slot:"mainhand",id:"ogvz:mainhand"}, \
      {type:"minecraft:attack_speed",name:"minecraft:attack_speed",amount:-2.8,operation:"add_value",slot:"mainhand",id:"ogvz:mainhand"} \ 
    ], \
    show_in_tooltip:false \
  }, \
  minecraft:can_break={ \
