# --------------------------------------------------------------------------------------------------------------------------------------------------------------
# Called By: ogvz:tick
# File Name: natural_regeneration
# Function Name: ogvz:tick/natural_regeneration
# File Purpose: Reworks how natural regeneration works.
...
# Credit to:
#
# Comments: Because Mojang devs are assholes and didn't let us use ticks for duration in the /effect command, area effect clouds had to be used.
# --------------------------------------------------------------------------------------------------------------------------------------------------------------
