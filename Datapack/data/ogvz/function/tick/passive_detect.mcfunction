...
# Chicken Nugget
execute as @s[tag=ogvz.zombie.class.chicken_nugget,scores={ogvz.inventory.featherlight=1..}] at @s run function ogvz:zombie/ability/chicken_nugget/featherlight
# Piglin
