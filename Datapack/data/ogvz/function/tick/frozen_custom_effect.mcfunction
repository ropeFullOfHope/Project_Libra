# --------------------------------------------------------------------------------------------------------------------------------------------------------------
# Called By: ogvz:tick
# File Name: frozen_custom_effect
# Function Name: ogvz:tick/frozen_custom_effect
# File Purpose: Prevents the player from moving when under the effect of bad luck.
