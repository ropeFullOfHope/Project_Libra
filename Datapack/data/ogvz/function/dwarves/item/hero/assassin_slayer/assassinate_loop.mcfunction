...
# Function Name: ogvz:dwarves/item/hero/assassin_slayer/assassinate_loop
...
execute as @s at @s run function ogvz:dwarves/item/hero/assassin_slayer/assassinate_loop
