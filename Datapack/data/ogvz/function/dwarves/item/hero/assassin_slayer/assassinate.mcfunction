...
# Function Name: ogvz:dwarves/item/hero/assassin_slayer/assassinate
...
execute as @n[type=minecraft:marker,tag=temp.ray] at @s run function ogvz:dwarves/item/hero/assassin_slayer/assassinate_loop
