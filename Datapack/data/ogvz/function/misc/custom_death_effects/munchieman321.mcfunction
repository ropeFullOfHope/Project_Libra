...
# Function Name: ogvz:misc/custom_death_effects/munchieman321
# File Purpose: Custom death animation for Ozald (large sum donation).
...
execute if score &ogvz temp.custom_death_animation.munchieman321 matches 1 summon minecraft:marker run tag @s add ogvz.marker
execute if score &ogvz temp.custom_death_animation.munchieman321 matches 1 run tag @n[type=minecraft:marker,tag=ogvz.marker] add ogvz.marker.munchie_percent
