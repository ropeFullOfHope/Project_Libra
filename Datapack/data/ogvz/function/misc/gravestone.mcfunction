...
execute as @s[predicate=ogvz:player/is_muffinarcades] align xyz run summon minecraft:block_display ~0.125 ~ ~0.125 {Tags:["ogvz.block_display","ogvz.block_display.gravestone","ogvz.kill_on_reload"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.75f,0.75f,0.75f]},block_state:{Name:"minecraft:nether_brick_wall",Properties:{east:"low",west:"low"}}}
execute as @s[predicate=ogvz:player/is_muffinarcades] align xyz run summon minecraft:text_display ~0.5 ~0.42 ~0.6975 {Tags:["ogvz.text_display","ogvz.text_display.gravestone","ogvz.kill_on_reload"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.3f,0.3f,0.3f]},text:'[{"selector":"@p[predicate=ogvz:player/is_muffinarcades]"}]',alignment:"center",background:0}
