...
title @s[scores={temp.custom_bar_value=..0}] actionbar {"font":"ogvz:custom","text":"\uF1A3\u1210\u1210"}
title @s[scores={temp.custom_bar_value=1}  ] actionbar {"font":"ogvz:custom","text":"\uF1A3\u1211\u1210"}
title @s[scores={temp.custom_bar_value=2..}] actionbar {"font":"ogvz:custom","text":"\uF1A3\u1211\u1211"}
