...
scoreboard players set @s ogvz.phantom.reusable_firework_rocket.cooldown.ticks 0
scoreboard players set @s ogvz.blaze.firefly.duration.ticks 0
scoreboard players set @s ogvz.hoglin.experience 0
scoreboard players set @s ogvz.hoglin.use.golden_pickaxe 0
...
scoreboard players set @s ogvz.ocelot.steal_mana.cooldown.ticks 0
scoreboard players set @s ogvz.ocelot.steal_mana.cooldown.seconds 0
scoreboard players set @s ogvz.chicken_nugget.fly.cooldown.ticks 0
scoreboard players set @s ogvz.chicken_nugget.fly.cooldown.seconds 0
...
scoreboard players set @s ogvz.snowman.icicle.cooldown.ticks 0
scoreboard players set @s ogvz.snowman.icicle.cooldown.seconds 0
scoreboard players set @s ogvz.chillager.ice_cube.cooldown.ticks 0
scoreboard players set @s ogvz.chillager.ice_cube.cooldown.seconds 0
...
scoreboard players set @s ogvz.blaze.fireblast.cooldown.ticks 0
scoreboard players set @s ogvz.blaze.fireblast.cooldown.seconds 0
...
scoreboard players set @s ogvz.enderman.portal.cooldown.ticks 0
scoreboard players set @s ogvz.enderman.portal.cooldown.seconds 0
scoreboard players set @s ogvz.enderman.reinforce.cooldown.ticks 0
scoreboard players set @s ogvz.enderman.reinforce.cooldown.seconds 0