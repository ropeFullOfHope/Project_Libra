...
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~-0.5 ~0.5 ~-0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~-0.5 ~0.5 ~0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~0.5 ~0.5 ~-0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~0.5 ~0.5 ~0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~-0.5 ~1.5 ~-0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~-0.5 ~1.5 ~0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~0.5 ~1.5 ~-0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] unless block ~0.5 ~1.5 ~0.5 #ogvz:go_through run scoreboard players set @s ogvz.var 1
...
execute if entity @s[scores={ogvz.var=1}] run return 0

# Check if the shrine is webbed.
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~-0.5 ~0.5 ~-0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~-0.5 ~0.5 ~0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~0.5 ~0.5 ~-0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~0.5 ~0.5 ~0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~-0.5 ~1.5 ~-0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~-0.5 ~1.5 ~0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~0.5 ~1.5 ~-0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
execute at @e[type=minecraft:marker,tag=ogvz.marker.shrine,limit=1,sort=nearest] if block ~0.5 ~1.5 ~0.5 minecraft:cobweb run scoreboard players set @s ogvz.var 1
...
# Remove 50 levels.
scoreboard players remove @s ogvz.dwarf.mana_buildup 50000
