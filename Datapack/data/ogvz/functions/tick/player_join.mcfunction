...
execute as @s[tag=!joined] if entity @e[type=minecraft:marker,tag=dvz,tag=!setup_phase] at @s run function ogvz:give/magma_cream
...
execute if entity @e[type=minecraft:marker,tag=dvz,tag=build_phase] run bossbar set ogvz:boss_timer players @a
execute if entity @e[type=minecraft:marker,tag=dvz,tag=boss_phase,tag=boss_dragon] run bossbar set ogvz:dragon_health players @a
execute if entity @e[type=minecraft:marker,tag=dvz,tag=boss_phase,tag=boss_ai_dragon] run bossbar set ogvz:dragon_health players @a
execute if entity @e[type=minecraft:marker,tag=dvz,tag=boss_phase,tag=boss_guardian] run bossbar set ogvz:guardian_health players @a
execute if entity @e[type=minecraft:marker,tag=dvz,tag=boss_phase,tag=boss_assassin] run bossbar set ogvz:assassin_timer players @a