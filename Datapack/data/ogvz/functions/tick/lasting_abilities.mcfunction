...
# Function Name: ogvz:tick/lasting_abilities
...
# Chicken Nugget - Fly
execute as @a[tag=chicken_nugget,scores={ogvz.chicken_nugget.fly.ticks=1..}] at @s run function ogvz:zombies/chicken_nugget/fly_loop
...
# Snowman - Icicle
execute as @a[scores={ogvz.chillager.icicle.freeze.ticks=1..}] at @s run function ogvz:zombies/snowman/icicle_freeze_loop

# Chillager - Invisibility
execute as @a[scores={ogvz.chillager.invisibility.duration.ticks=1..}] at @s run function ogvz:zombies/chillager/invisibility_loop

# Chillager - Ice Cube
execute as @a[tag=!chillager,scores={ogvz.inventory.7071=1..}] at @s run function ogvz:zombies/chillager/ice_cube_box
...
# Blaze - Fly
execute as @a[tag=blaze,scores={ogvz.blaze.firefly.duration.ticks=1..}] at @s run function ogvz:zombies/blaze/firefly_loop

# Hoglin - Golden Pickaxe
execute as @a[tag=hoglin,scores={ogvz.hoglin.use.golden_pickaxe=1..}] at @s run function ogvz:zombies/hoglin/eat