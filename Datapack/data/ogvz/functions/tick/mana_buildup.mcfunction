...
execute unless entity @e[type=minecraft:marker,tag=shrine,distance=..8] run scoreboard players remove @s[tag=!builder,level=101..,predicate=!dvz:effect/hero_of_the_village] ogvz.dwarf.mana_buildup 10
