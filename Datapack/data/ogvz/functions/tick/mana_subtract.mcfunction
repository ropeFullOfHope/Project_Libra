...
scoreboard players add @s ogvz.dwarf.mana_buildup 1000000
...
# Repeat function until ogvz.dwarf.mana_buildup is above -1000000 micromana.
execute as @s[scores={ogvz.dwarf.mana_buildup=..-1000000}] at @s run function ogvz:tick/mana_subtract