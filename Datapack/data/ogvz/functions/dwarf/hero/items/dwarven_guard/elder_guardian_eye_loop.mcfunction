...
# Spiraling particles.
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=0} ] positioned ^00.00 ^00.25 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=1} ] positioned ^-0.13 ^00.22 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=2} ] positioned ^-0.22 ^00.13 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=3} ] positioned ^-0.25 ^00.00 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=4} ] positioned ^-0.22 ^-0.13 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=5} ] positioned ^-0.13 ^-0.22 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=6} ] positioned ^00.00 ^-0.25 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=7} ] positioned ^00.13 ^-0.22 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=8} ] positioned ^00.22 ^-0.13 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=9} ] positioned ^00.25 ^00.00 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=10}] positioned ^00.22 ^00.13 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=11}] positioned ^00.13 ^00.22 ^ run particle minecraft:wax_off ~ ~ ~ 0 0 0 0 1 force

# Iterates the spin from 0 to 11 repeatedly.
scoreboard players add @p[tag=temp_ray_origin,distance=2..] ogvz.spin.temp 1
execute as @p[tag=temp_ray_origin,distance=2..] if entity @s[scores={ogvz.spin.temp=12..}] run scoreboard players set @s ogvz.spin.temp 0 
