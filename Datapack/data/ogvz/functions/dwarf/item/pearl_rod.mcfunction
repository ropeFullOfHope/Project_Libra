...
execute if entity @s[scores={ogvz.pearl_rod.cool=1..}] run title @s actionbar [ \
  "", \
  {"text":"[Pearl Rod]","bold":true,"color":"dark_red"}, \
...
execute if entity @s[scores={ogvz.pearl_rod.cool=1..}] run return 0
...
scoreboard players set @s ogvz.pearl_rod.cool 60
