    ...
    pages:[ \
      { \
        raw:'[ \
          ...
          {"text":"\\n"}, \
          {"text":"\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Legacy Setup"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/setup_panel"}}, \
          {"text":" Legacy Setup\\n"} \
        ]' \
      }, \
      { \
        raw:'[ \
          ...
          {"text":"\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Start Game!"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/start_game"}}, \
          {"text":" Start Game!\\n"}, \
          {"text":"\\n"}, \
          {"text":"Set Location:\\n","bold":true}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Lobby"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/set_lobby_location"}}, \
          {"text":" Lobby\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Shrine"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/set_shrine_location"}}, \
          {"text":" Shrine\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Zombie Spawn"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/set_zombie_spawn_location"}}, \
          {"text":" Zombie Spawn\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Boss Spawn"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/set_boss_spawn_location"}}, \
          {"text":" Boss Spawn\\n"} \
        ]' \
      }, \
      { \
        raw:'[ \
          ...
          {"text":"\\n"}, \
          {"text":"Place Lobby:\\n","bold":true}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Standard"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/place_lobby_standard"}}, \
          {"text":" Standard\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Parkour"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/place_lobby_parkour"}}, \
          {"text":" Parkour\\n"} \
        ]' \
      }, \
      { \
        raw:'[ \
          ...
          {"text":"\\n"}, \
          {"text":"Place Shrine:\\n","bold":true}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Standard"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/place_shrine_standard"}}, \
          {"text":" Standard\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Platform"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/place_shrine_platform"}}, \
          {"text":" Platform\\n"} \
        ]' \
      }, \
      { \
        raw:'[ \
          ...
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Standard"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/place_zombie_spawn_standard"}}, \
          {"text":" Standard"} \
        ]' \
      }, \
      { \
        raw:'[ \
          ...
          {"text":"\\n"}, \
          {"text":"Select Boss:\\n","bold":true}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Dragon"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/select_dragon"}}, \
          {"text":" Dragon\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Wither"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/select_wither"}}, \
          {"text":" Wither\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Elder Guardian"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/select_guardian"}}, \
          {"text":" Elder Guardian\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"Assassin"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/select_assassin"}}, \
          {"text":" Assassin\\n"}, \
          {"text":"\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"AI Dragon"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/select_ai_dragon"}}, \
          {"text":" AI Dragon\\n"}, \
          {"text":"[+]","hoverEvent":{"action":"show_text","value":[{"text":"AI Wither"}]},"clickEvent":{"action":"run_command","value":"/execute as @s[tag=dvz.admin] at @s run function dvz:admin/setup/select_ai_wither"}}, \
          {"text":" AI Wither\\n"} \
        ]' \
      }, \
      { \
