...
execute on origin as @s[scores={ogvz.wither_warrior.whispersong.flame.ticks=1..}] if items entity @s weapon.offhand minecraft:bow[minecraft:custom_data={soul_power:1}] as @e[type=minecraft:arrow,tag=applying_enchantments] run tag @s add soul_power
