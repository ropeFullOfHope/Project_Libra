...
scoreboard players add @s[tag=!ogvz.dwarf.class.builder] ogvz.dwarf.mana_buildup.micromana 50000
scoreboard players add @s[tag=ogvz.dwarf.class.builder] ogvz.dwarf.mana_buildup.micromana 25000
