...
execute unless entity @s[scores={DVZ.rclick=1..}] run return 0
...
execute unless entity @s[scores={DVZ.rclick.cool=0}] run return 0

scoreboard players set @s DVZ.rclick.cool 5
