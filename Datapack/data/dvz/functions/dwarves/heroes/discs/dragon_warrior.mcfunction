...
item replace entity @s[tag=dvz.use_mainhand] weapon.mainhand with minecraft:air
item replace entity @s[tag=dvz.use_offhand] weapon.offhand with minecraft:air
