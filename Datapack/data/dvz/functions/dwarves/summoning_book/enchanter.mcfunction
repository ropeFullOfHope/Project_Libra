...
execute store result score @s DVZ.result.score run clear @s minecraft:emerald 0
execute unless entity @s[scores={DVZ.result.score=1..}] run title @s actionbar [ \
  "", \
...
execute unless entity @s[scores={DVZ.result.score=1..}] run return 0
