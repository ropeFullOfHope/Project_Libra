...
execute store result score @s DVZ.result.score run clear @s minecraft:brick 0
execute unless entity @s[scores={DVZ.result.score=10..}] run title @s actionbar [ \
  "", \
...
execute unless entity @s[scores={DVZ.result.score=10..}] run return 0
