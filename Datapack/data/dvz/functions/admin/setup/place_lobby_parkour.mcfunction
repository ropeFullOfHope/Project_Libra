# --------------------------------------------------------------------------------------------------------------------------------------------------------------
# Called By: 
# File Name: place_lobby_parkour
# Function Name: dvz:admin/setup/place_lobby_parkour
# File Purpose: Places a randomized parkour lobby.
...
place structure dvz:random_parkour

execute at @e[type=minecraft:marker,tag=lobby,limit=1,sort=nearest] run tp @s ~ ~ ~
...
tellraw @a [ \
  ...
  {"selector":"@s"}, \
  {"text":" placed a randomized parkour lobby.","color":"green"} \
]