...
# File Name: beam_loop
# Function Name: dvz:zombies/guardian/beam_loop
# File Purpose: Ray scanning for Guardian's beam.
...
execute if entity @p[tag=temp_ray_origin,distance=2..] run particle minecraft:dust_color_transition 0 1 0.6 2 0.4 0 0.6 ~ ~ ~ 0.05 0.05 0.05 0.1 3 force
...
execute as @s at @s run function dvz:zombies/guardian/beam_loop