...
scoreboard players add &dvz DVZ.game.tick 1
...
scoreboard players remove @a[tag=wither_warrior,scores={DVZ.whispersong_flame.tick=1..}] DVZ.whispersong_flame.tick 1