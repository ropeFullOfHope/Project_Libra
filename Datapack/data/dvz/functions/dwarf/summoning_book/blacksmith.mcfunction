...
execute store result score @s dvz.var run clear @s minecraft:clock 0
execute unless entity @s[scores={dvz.var=5..}] run title @s actionbar [ \
  "", \
...
execute unless entity @s[scores={dvz.var=5..}] run return 0
