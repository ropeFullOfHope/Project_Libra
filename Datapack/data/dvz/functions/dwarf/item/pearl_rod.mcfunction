...
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~-0.5 ~0.5 ~-0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~-0.5 ~0.5 ~0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~0.5 ~0.5 ~-0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~0.5 ~0.5 ~0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~-0.5 ~1.5 ~-0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~-0.5 ~1.5 ~0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~0.5 ~1.5 ~-0.5 #dvz:go_through run scoreboard players set @s dvz.var 1
execute at @e[type=minecraft:marker,tag=shrine,limit=1,sort=nearest] unless block ~0.5 ~1.5 ~0.5 #dvz:go_through run scoreboard players set @s dvz.var 1

execute if entity @s[scores={dvz.var=1}] run title @s actionbar [ \
  "", \
  {"text":"[Pearl Rod]","bold":true,"color":"dark_red"}, \
